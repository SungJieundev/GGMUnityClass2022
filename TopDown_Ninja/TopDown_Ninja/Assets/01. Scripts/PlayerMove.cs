...
public class PlayerMove : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //SetAccelerationParameters(dir);  
        //speed = CalculateSpeed(dir, _animationCurve);
    ...
    // void SetAccelerationParameters(Vector2 input)
    // {
    ...
    // float CalculateSpeed(Vector2 input, AnimationCurve animationCurve)
    // {
    //     if (isMoving)
    //     {
